...
<tr>
<td>GRID values</td>
<td><input type="text" maxlength="2" name="first" id="first"/></td>
<td><input type="text" maxlength="2" name="second" id="second"/></td>
<td><input type="text" maxlength="2" name="third" id="third"/></td>
</tr>
</table>
<br><br>
