...
<%@ include file="JSP/header.jsp" %> 
 ...
 <tr>
 <td>Name on Card </td>
 <td><input type="text" value="" name="cardname" id="cardname"/></td>
 ...
 <tr>
 <td>CVV </td>
 <td><input type="password" value="" name="cvv" id="cvv" maxlength="3"/></td>
 </tr>
 ...
 <!--<tr>
 <td>CVV </td>
 <td><input type="text" value="" name="cvv" maxlength="3"/></td>
 </tr>-->
 
 
 <tr>
 <td>Transaction Password </td>
 <td><input type="password" value="" name="transactionpassword" id="transactionpassword" /></td>
 </tr>
